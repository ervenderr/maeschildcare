...
export const metadata: Metadata = {
  ...
  description: 'Meet the loving and dedicated teachers at Mae\'s Childcare who make learning fun and nurturing.',
}
      ...
      <section className="bg-gradient-to-br from-softTeal to-pastelYellow py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto animate-scaleIn">
            The loving and dedicated teachers who make Mae's Childcare special
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-creamWhite">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xl text-navyText/80 leading-relaxed">
            Our staff members are carefully selected for their experience, passion, and dedication to early childhood education. Each teacher brings unique skills and a warm heart to create a nurturing environment where children thrive.
          </p>
        </div>
      </section>
                ...
                <div className="bg-gradient-to-br from-pastelYellow to-yellow-100 p-6 rounded-2xl">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-navyText/80">Early Childhood Development</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-lightCoral mr-2">✦</span>
                      <span className="text-navyText/80">Play-Based Learning</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-lightCoral mr-2">✦</span>
                      <span className="text-navyText/80">Parent Partnership & Communication</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="order-2 md:order-1">
                ...
                <div className="bg-gradient-to-br from-skyBlue to-blue-100 p-6 rounded-2xl">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="text-softTeal mr-2">✦</span>
                      <span className="text-navyText/80">Creative Expression</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-lg">
              ...
              <h3 className="text-2xl font-heading font-bold text-navyText mb-4">Listening & Understanding</h3>
              <p className="text-navyText/80">
                We take time to truly understand each child's unique personality, interests, and needs.
              </p>
            </div>

            <div className="bg-white p-8 rounded-3xl shadow-lg">
              <div className="text-5xl mb-4">🎯</div>
              <h3 className="text-2xl font-heading font-bold text-navyText mb-4">Individualized Care</h3>
              <p className="text-navyText/80">
                Our low student-to-teacher ratios ensure every child receives personalized attention.
              </p>
            </div>

            <div className="bg-white p-8 rounded-3xl shadow-lg">
              <div className="text-5xl mb-4">💪</div>
              <h3 className="text-2xl font-heading font-bold text-navyText mb-4">Continuous Growth</h3>
              <p className="text-navyText/80">
                Our staff regularly participates in professional development and training programs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-navyText text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Schedule a visit to meet our wonderful staff and see our caring environment in action.
          </p>
          <a
            href="/contact"
