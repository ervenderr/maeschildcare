          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-navyText/80">
                A licensed childcare home in San Francisco providing bilingual education, art-based learning, and nurturing care for children ages 4 months to 5 years.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-pastelYellow to-yellow-100 p-8 rounded-3xl shadow-lg hover:shadow-xl hover-lift transition animate-scaleIn">
              ...
              <p className="text-sm text-navyText/70 mb-2">4 months – 2 years</p>
